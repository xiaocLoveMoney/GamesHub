          ...
          {showSettings && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
               ...
               >
                  ...
                  {/* 球速设置 */}
                  <div className="mb-6">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 block">球移动速度</label>
                  ...
                  {/* 砖块数量设置 */}
                  <div className="mb-6">
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 block">砖块数量/密度</label>
                    <div className="grid grid-cols-3 gap-2">
        ...
        <div className="bg-white p-1 rounded-[2rem] shadow-lg border border-slate-100 w-full max-w-2xl relative z-10">
               ...
               <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex flex-col items-center justify-center z-30">
                  {gameStatus === 'won' && (
                    <div className="text-center text-amber-500 mb-6 animate-bounce">
                      <Trophy size={80} />
                      <h2 className="text-4xl font-bold mt-4 text-slate-800">通关!</h2>
                    </div>
                  )}
                  {gameStatus === 'lost' && (
                    <div className="text-center mb-6">
                      <h2 className="text-4xl font-bold text-slate-800 mb-2">游戏结束</h2>
                      <p className="text-slate-500">最终得分: {score}</p>
                    </div>
                  )}
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      <div className="relative flex items-center gap-3">
                        ...
                        <span className="text-lg">{gameStatus === 'start' ? '开始挑战' : '再试一次'}</span>
                      </div>
                    </button>
          ...
          <div className="flex justify-between items-center mt-4 mb-2 text-slate-400 text-sm px-4">
             ...
             <div className="flex gap-4 text-xs font-mono">
                <span>速度: {SPEEDS[config.speed].label}</span>
                <span>密度: {LAYOUTS[config.layout].label}</span>
             </div>
          </div>
        </div>
      </div>
